...
public final class UpdateShoppingCart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      query.ShoppingCart cart = null;
      synchronized (session) {
        cart = (query.ShoppingCart) _jspx_page_context.getAttribute("cart", PageContext.SESSION_SCOPE);
        if (cart == null){
          cart = new query.ShoppingCart();
  ...
  private boolean _jspx_meth_sql_update_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_sql_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            INSERT INTO ShoppingCart VALUES (\"what\", \"what, \"what\");\n");
          out.write("        ");
